...
namespace The4Dimension.Ohana
{
    public class RenderBase
    {
        ...
        public class OVector3
        {
            ...
            /// <returns></returns>
            public  OVector3 transform(OVector3 input, OMatrix matrix)
            {
        ...
        { //4x4
            ...
            /// <returns></returns>
            public  OMatrix scale(OVector3 scale)
            {
                OMatrix output = new OMatrix
                {
                    M11 = scale.x,
            ...
            /// <param name="scale">The Scale proportions</param>
            /// <returns></returns>
            public  OMatrix scale(OVector2 scale)
            {
                OMatrix output = new OMatrix
                {
                    M11 = scale.x,
            ...
            /// <returns></returns>
            public  OMatrix scale(float scale)
            {
                OMatrix output = new OMatrix
                {
                    M11 = scale,
            ...
            /// <returns></returns>
            public  OMatrix rotateX(float angle)
            {
                OMatrix output = new OMatrix
                {
            ...
            /// <param name="angle">Angle in radians</param>
            /// <returns></returns>
            public  OMatrix rotateY(float angle)
            {
                OMatrix output = new OMatrix
                {
            ...
            /// <param name="angle">Angle in radians</param>
            /// <returns></returns>
            public  OMatrix rotateZ(float angle)
            {
                OMatrix output = new OMatrix
                {
                    M11 = (float)Math.Cos(angle),
            ...
            /// <returns></returns>
            public  OMatrix translate(OVector3 position)
            {
                OMatrix output = new OMatrix
                {
                    M41 = position.x,
            ...
            /// <param name="position">The Position offset</param>
            /// <returns></returns>
            public  OMatrix translate(OVector2 position)
            {
                OMatrix output = new OMatrix
                {
                    M31 = position.x,
