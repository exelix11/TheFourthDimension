...
namespace The4Dimension.Ohana
{
    class MeshUtils
    {
        ...
        public  void calculateBounds(RenderBase.OModel mdl, RenderBase.OVertex vertex)
        {
        ...
        /// <returns></returns>
        public  Color getColor(BinaryReader input)
        {
        ...
        /// <param name="input">CGFX reader</param>
        /// <returns></returns>
        public  Color getColorFloat(BinaryReader input)
        {
        ...
        /// <returns></returns>
        public  byte saturate(float value)
        {
        ...
        /// <returns></returns>
        public  optimizedMesh optimizeMesh(RenderBase.OMesh mesh)
        {
