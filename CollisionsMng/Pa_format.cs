...
namespace CollisionsMng
{
    class Pa_format
    {
        ...
        public byte[] MakeFile()
        {
            ...
            bin.Write(EntrySize);
            for (int i = 0; i < NumFields; i++) bin.Write(Pa_Field.GetDefaultField(i).GetSection());
        ...
        public override string ToString()
        {
            ...
            Res += "Entries list:\r\n";
            foreach (UInt32 n in entries) Res += " -" + Pa_Field.GetString(BitConverter.GetBytes(n));
            return Res;
        }
    ...
    class Pa_Field
    {
        ...
        public override string ToString()
        {
            ...
            Res += "-Field Name: " + name + "\r\n";
            Res += " |Field bitmask: " + GetString(Bitmask) + "\r\n";
        ...
        public static Pa_Field GetDefaultField(int index)
        {
            ...
            switch (index)
            {
                case 0:
                    ...
                    res.Bitmask = new byte[] { 0x7F, 0x00, 0x00, 0x00 };
                    res.offsetInEntry = 0;
                    res.Shift = 0;
                    res.Type = 0;
                    return res;
                case 1:
                    ...
                    res.Bitmask = new byte[] { 0x80, 0x1F, 0x00, 0x00 };
                    res.offsetInEntry = 0;
                    res.Shift = 7;
                    res.Type = 0;
                    return res;
                case 2:
                    ...
                    res.Bitmask = new byte[] { 0x00, 0xE0, 0x07, 0x00 };
                    res.offsetInEntry = 0;
                    res.Shift = 0xD;
                    res.Type = 0;
                    return res;
                case 3:
                    ...
                    res.Bitmask = new byte[] { 0x00, 0x00, 0x78, 0x00 };
                    res.offsetInEntry = 0;
                    res.Shift = 0x13;
                    res.Type = 0;
                    return res;
                case 4:
                    ...
                    res.Bitmask = new byte[] { 0x00, 0x00, 0x80, 0x00 };
                    res.offsetInEntry = 0;
                    res.Shift = 0x17;
                    res.Type = 0;
                    return res;
